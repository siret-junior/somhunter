...
cd somhunter-core
docker build --no-cache -t somhunter-core .
cd ..
printf "\tDone.\n"
...
cd somhunter-ui
docker build --no-cache -t somhunter-ui .
cd ..
printf "\tDone.\n"
...
docker build --no-cache -t somhunter-data-server .
cd ..
printf "\tDone.\n"
...
cd ranking-server
docker build --no-cache -t ranking-server .
cd ..
printf "\tDone.\n"
