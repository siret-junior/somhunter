...
async function loginToDres(settings, onSucc = () => null, onFail = () => null) {
  ...
  const submitterConfig = config.core.submitter_config;
...
function initialize(s) {
  ...
  const shouldSend = config.core.submitter_config.submit_to_VBS;
...
function getCommonBodyJsx(s) {
  const cfg = config.core.submitter_config;
  return (
    <>
      <p>
        <strong>Core API config generated: </strong>
        {config.generated}
      </p>
      <hr />
      <p>
...
function getDresBodyJsx(s) {
  const cfg = config.core.submitter_config.server_config.dres;
...
function SettingsWindow(props) {
  ...
  const serverCfg = config.core.submitter_config;
  const coreEndpoints = config.api.endpoints;
