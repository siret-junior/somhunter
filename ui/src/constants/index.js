...
export const SET_COLLAGE_CHANGED = "SET_COLLAGE_CHANGED";
...
export const RESET_LIKED_FRAMES = "RESET_LIKED_FRAME";

export const ADD_BOOKMARKED_FRAME = "ADD_BOOKMARKED_FRAME";
export const REMOVE_BOOKMARKED_FRAME = "REMOVE_BOOKMARKED_FRAME";
export const RESET_BOOKMARKED_FRAMES = "RESET_BOOKMARKED_FRAME";

export const SHOW_ZOOM_WINDOW = "SHOW_ZOOM_WINDOW";
export const HIDE_ZOOM_WINDOW = "HIDE_ZOOM_WINDOW";
